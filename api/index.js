...
var pgClient = new Client({
  host: '127.0.0.1',
  user: 'admin_pfp',   // Usuario maestro
  password: 'PFP_BD_2024',  // Contraseña maestra
  database: 'PFP',   // Nombre de la base de datos
  port: 5432,  // El puerto por defecto de PostgreSQL es 5432
  multipleStatements: true  // PostgreSQL no requiere esto como en MySQL
});
...
app.listen(3000, () => console.log("Server Running en el perto:3000"));
 ...
 // Endpoint para obtener todos los registros de la tabla TBL_PAIS
  ...
  app.get("/get_estado_canje", (req, res) => {
    ...
    pgClient.query(query, (err, result) => {
      if (!err) {
        ...
        res.status(500).send("Error al obtener los datos de estado de canje");
      }
    });
  });
  ...
  app.put("/update_estado_canje", (req, res) => {
    ...
    if (!id_estado_canje || !estado_canje) {
      return res
        .status(400)
        .send("Todos los campos son requeridos (id_estado_canje, estado_canje)");
    }
  ...
  app.get("/get_tipo_entidad", (req, res) => {
    ...
    pgClient.query(query, (err, result) => {
      if (!err) {
        ...
        res.status(500).send("Error al obtener los datos de tipo de entidad");
      }
    });
  });
  ...
  app.get("/get_tipo_registro", (req, res) => {
    ...
    pgClient.query(query, (err, result) => {
      if (!err) {
        ...
        res.status(500).send("Error al obtener los datos de tipo de registro");
      }
    });
  });
  ...
  app.get("/get_unidad_medida", (req, res) => {
    ...
    pgClient.query(query, (err, result) => {
      if (!err) {
        ...
        res.status(500).send("Error al obtener los datos de unidad de medida");
      }
    });
  });
  ...
  app.post("/insert_rol", (req, res) => {
    ...
    if (!rol || !descripcion || !id_estado) {
      return res
        .status(400)
        .send("Todos los campos son requeridos (rol, descripcion, id_estado)");
    }
  ...
  app.get("/get_via_administracion", (req, res) => {
    ...
    pgClient.query(query, (err, result) => {
      if (!err) {
        ...
        res
          .status(500)
          .send("Error al obtener los datos de vía de administración");
      }
    });
  });
  ...
  app.post("/insert_via_administracion", (req, res) => {
    ...
    if (!via_administracion || !id_estado) {
      return res
        .status(400)
        .send("Todos los campos son requeridos (via_administracion, id_estado)");
    }
    ...
    pgClient.query(query, values, (err, result) => {
      if (!err) {
        res.status(200).send("Vía de administración insertada exitosamente");
      } else {
        console.log(err);
  ...
  app.put("/update_via_administracion", (req, res) => {
    ...
    pgClient.query(query, values, (err, result) => {
      if (!err) {
        res.status(200).send("Vía de administración actualizada exitosamente");
      } else {
        console.log(err);
        res.status(500).send("Error al actualizar la vía de administración");
      }
    });
  });
  ...
  app.put("/update_departamento", (req, res) => {
    const { id_zona, id_departamento, nombre_departamento, id_estado } = req.body; // Capturamos los valores desde el cuerpo de la solicitud
  ...
  app.post("/insert_especialidad", (req, res) => {
    ...
    if (!nombre_especialidad || !id_estado) {
      return res
        .status(400)
        .send("Todos los campos son requeridos (nombre_especialidad, id_estado)");
    }
  ...
  app.get("/get_forma_farmaceutica", (req, res) => {
    ...
    pgClient.query(query, (err, result) => {
      if (!err) {
        ...
        res.status(500).send("Error al obtener los datos de forma farmacéutica");
      }
    });
  });
  ...
  app.post("/insert_forma_farmaceutica", (req, res) => {
    ...
    if (!forma_farmaceutica || !id_estado) {
      return res
        .status(400)
        .send("Todos los campos son requeridos (forma_farmaceutica, id_estado)");
    }
  ...
  app.get("/get_tipo_contacto", (req, res) => {
    ...
    pgClient.query(query, (err, result) => {
      if (!err) {
        ...
        res.status(500).send("Error al obtener los datos de tipo de contacto");
      }
    });
  });
  ...
  app.get("/get_marca_producto", (req, res) => {
    ...
    pgClient.query(query, (err, result) => {
      if (!err) {
        ...
        res.status(500).send("Error al obtener los datos de marca de producto");
      }
    });
  });
  ...
  app.post("/insert_marca_producto", (req, res) => {
    ...
    if (!marca_producto || !id_estado) {
      return res
        .status(400)
        .send("Todos los campos son requeridos (marca_producto, id_estado)");
    }
  ...
  app.get("/get_lote_producto", (req, res) => {
    ...
    pgClient.query(query, (err, result) => {
      if (!err) {
        ...
        res.status(500).send("Error al obtener los datos de lote de producto");
      }
    });
  });
  ...
  app.post("/insert_lote_producto", (req, res) => {
    const { lote_producto, id_producto, fecha_vencimiento, id_estado } = req.body; // Capturamos los valores desde el cuerpo de la solicitud
  ...
  app.get("/get_sucursales", (req, res) => {
    ...
    pgClient.query(query, (err, result) => {
      if (!err) {
        ...
        res
          .status(500)
          .send("Error al obtener los datos de detalles de sucursales");
      }
    });
  });
  ...
  app.get("/get_contactos", (req, res) => {
    ...
    pgClient.query(query, (err, result) => {
      if (!err) {
        ...
        res
          .status(500)
          .send("Error al obtener los datos de detalles de contactos");
      }
    });
  });
  ...
  app.get("/get_distribuidores", (req, res) => {
    ...
    pgClient.query(query, (err, result) => {
      if (!err) {
        ...
        res
          .status(500)
          .send("Error al obtener los datos de detalles de distribuidores");
      }
    });
  });
  ...
  app.get("/get_laboratorios", (req, res) => {
    ...
    pgClient.query(query, (err, result) => {
      if (!err) {
        ...
        res
          .status(500)
          .send("Error al obtener los datos de detalles de laboratorios");
      }
    });
  });
  ...
  app.get("/get_pacientes", (req, res) => {
    ...
    pgClient.query(query, (err, result) => {
      if (!err) {
        ...
        res
          .status(500)
          .send("Error al obtener los datos de detalles de pacientes");
      }
    });
  });
...
app.get("/get_facturas", (req, res) => {
    ...
    pgClient.query(query, (err, result) => {
      if (!err) {
        ...
        res
          .status(500)
          .send("Error al obtener los datos de facturas y pacientes");
      }
    });
  });
  ...
  app.get("/get_farmacias", (req, res) => {
    ...
    pgClient.query(query, (err, result) => {
      if (!err) {
        ...
        res
          .status(500)
          .send("Error al obtener los datos de detalles de farmacias");
      }
    });
  });
...
app.post('/insert_permiso', (req, res) => {
    const { id_rol, id_objeto, permiso_creacion, permiso_actualizacion, permiso_eliminacion, permiso_consultar, id_estado } = req.body;

    if (!id_rol || !id_objeto || !permiso_creacion || !permiso_actualizacion || !permiso_eliminacion || !permiso_consultar || !id_estado) {
        return res.status(400).send('Todos los campos son obligatorios');
    }

    const query = 'CALL pfp_schema.insert_permiso($1, $2, $3, $4, $5, $6, $7)';
    const values = [id_rol, id_objeto, permiso_creacion, permiso_actualizacion, permiso_eliminacion, permiso_consultar, id_estado];
...
app.put('/update_permiso', (req, res) => {
    const { id_permiso, id_rol, id_objeto, permiso_creacion, permiso_actualizacion, permiso_eliminacion, permiso_consultar, id_estado } = req.body;

    if (!id_permiso || !id_rol || !id_objeto || !permiso_creacion || !permiso_actualizacion || !permiso_eliminacion || !permiso_consultar || !id_estado) {
        return res.status(400).send('Todos los campos son obligatorios');
    }

    const query = 'CALL pfp_schema.update_permiso($1, $2, $3, $4, $5, $6, $7, $8)';
    const values = [id_permiso, id_rol, id_objeto, permiso_creacion, permiso_actualizacion, permiso_eliminacion, permiso_consultar, id_estado];
