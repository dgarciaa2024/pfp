                ...
                <tr>
                  ...
                  <td>{{ $TContacto["creado_por"]}}</td>
                    ...
                    @if ($permiso_actualizacion == 1)
                                                    <a type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-editor-{{ $TContacto['id_tipo_contacto'] }}">
            ...
            <div class="col-12">
              <div class="form-group">
                ...
                <select id="estdo" name="estdo" class="form-control" requied>
                  ...
                  <option value="{{ $tbl['id_estado'] }}" @selected($TContacto['estado'] == $tbl['estado'])> {{$tbl["estado"]}}</option>
                  @endforeach
                </select>
              </div>
            </div>
